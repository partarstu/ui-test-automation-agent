...
docker build -t ui-test-automation-agent .
...
docker run -d -p 5901:5901 -p 6901:6901 -p 8005:8005 -e VNC_PW=123456 -e VNC_RESOLUTION=1920x1080 -e PORT=8005 --shm-size=4g --name ui-agent ui-test-automation-agent /dockerstartup/java_app_startup.sh
